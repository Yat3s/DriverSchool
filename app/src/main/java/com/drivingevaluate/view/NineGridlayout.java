...
public class NineGridlayout extends ViewGroup {
    ...
    private void layoutChildrenView(){
        ...
        for (int i = 0; i < childrenCount; i++) {
            ...
            childrenView.setImageUrl(((Image) listData.get(i)).getImgPath());
    ...
    private CustomImageView generateImageView() {
        ...
        iv.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                Log.e("Yat3s","onclick");
                Intent viewImgIntent = new Intent(getContext(), ViewImgActivity.class);
                viewImgIntent.putExtra("imgUrl", iv.getUrl());
                getContext().startActivity(viewImgIntent);
            }
        });
