...
import com.drivingevaluate.adapter.AlbumGridViewAdapter;
import com.drivingevaluate.util.ImageUtils.AlbumHelper;
import com.drivingevaluate.util.ImageUtils.Bimp;
import com.drivingevaluate.util.ImageUtils.ImageBucket;
...
//			intent.setClass(mContext, AddMomentActivity.class);
//			startActivity(intent);
			for (int i = 0; i < Bimp.tempSelectBitmap.size(); i++) {
				Log.e("Yat3s",Bimp.tempSelectBitmap.get(i).getImagePath());
			}
